...
> is exactly what this role describes: building Python frameworks and platforms
> that other engineering teams build on top of.
>
...
*(Target: 90 seconds. Hits: Plano, frameworks, platform thinking, Citi, HorizonScale)*
...
**Situation:** Citi had a fragmented, manual capacity planning process across 6,000+ endpoints.
**Task:** Build something automated, reusable, and reliable — not a one-off script.
**Action:** Designed a Python framework with reusable ingestion modules, Pandas transformation layers, Oracle schemas built for historical retention and extensibility. Any new data source could be onboarded without rewriting core logic.
**Result:** Replaced manual processes entirely. Multiple teams consumed the framework. Unified disparate feeds into a single reporting platform.
...
**Action:** Architected HorizonScale from scratch: parallel generator-based pipeline (90% faster), Prophet + scikit-learn ML models, Streamlit dashboard for real-time insights, RAG-based agentic reasoning layer. Built for extensibility — new data sources plug in without touching core logic.
**Result:** Forecasting cycles reduced 90%. Platform designed so other engineers could extend it without depending on me.
...
**Action:** Built documentation standards, code review practices, and onboarding templates. Mentored engineers on Python best practices, pipeline patterns, and AWS tooling.
**Result:** Team became self-sufficient on the framework. Onboarding time reduced. Code quality improved measurably.
...
> data needs. The Enterprise Platforms team appeals to me specifically because
...
> "My role was eliminated as part of a broader organizational restructuring —
...
## SQL — Prep Level For THIS Call: Zero
Codie is a recruiter. SQL will not come up technically.

**For technical screen — concepts only (no code writing yet):**
...
- Indexing strategy and query optimization concepts
- When to use SQL vs pipeline transformation (philosophy question)

---

## What Carries Over From Capital One Prep

| Capital One Story | Toyota Equivalent |
|------------------|------------------|
| Story 1 — ETL Automation | Reusable ETL Framework (re-framed) |
| Story 2 — ML Forecasting | HorizonScale Platform |
| Story 3 — Cost Savings | Supporting detail only |
| Story 4 — AWS Hybrid Platform | Cloud-Native Platform story |

Opening 2-min structure, salary script, "why hands-on IC", "interviewing elsewhere" — identical logic, new company name.

---

## Questions To Ask Codie

1. "What does the team structure look like for the Lead Python Developer role?"
2. "Is this a new headcount or a backfill?"
3. "What's the biggest platform challenge the Enterprise Platforms team is tackling right now?"
...
- [ ] Phone charged, quiet room ready at 12:50 PM Tuesday
