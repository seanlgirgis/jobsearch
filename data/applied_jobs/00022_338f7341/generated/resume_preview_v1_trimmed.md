...
Senior Data Engineer with over 20 years of enterprise experience, specializing in designing and maintaining optimal data pipelines for large-scale data processing using Python, SQL, and cloud platforms like AWS. Expert in building robust ETL/ELT processes, data warehousing, and ensuring data quality for actionable business insights. Skilled in leveraging AI/ML model building and data visualization tools to support data-driven decisions. Proven track record in collaborating with cross-functional teams to address complex challenges. Passionate about contributing to CVS Health’s mission of advancing healthcare through innovative data engineering solutions. Eager to apply expertise in data governance and schema design to drive impactful outcomes.
...
- Built unified Oracle reporting solutions with executive dashboards by integrating disparate data feeds.
- Identified underutilized infrastructure through data mining, driving significant cost savings via hardware consolidation.
- Automated reporting workflows and data cleansing using Python scripts for improved efficiency.

### Performance Engineer at G6 Hospitality LLC
2017-03 – 2017-11
- Managed Dynatrace AppMon/Synthetics for critical systems and Brand.com website monitoring.
...
- Analyzed bottlenecks and suggested performance improvements for enhanced system efficiency.
...
- Optimized agent and enterprise manager installations for improved performance.
...
- Ensured high-performance data handling for a system processing 10x VISA’s throughput.
- Collaborated with teams to refactor and enhance database architecture.
- Documented migration processes for future scalability and maintenance.
...
## Skills
Python, SQL / Oracle, ETL Design & Optimization, Data Warehousing, AWS, Pandas, PySpark, Prophet / Time-Series Forecasting, scikit-learn, GenAI / LLM Agents, Streamlit, Git, Docker, Airflow, Linux/Unix, Ksh / Korn Shell Scripting, Capacity Planning / Forecasting, Hive/Hadoop, Multiprocessing, BMC TrueSight / TSCO, C++, PL/SQL, Oracle RAC, OCCI / OCI, Java, Perl, Dynatrace (AppMon + Synthetics), CA APM / Introscope, WebLogic / WebSphere, VB6 / VC++

## Flagship Projects
### Serverless Lakehouse Platform (AWS)
Designed a full serverless data platform using S3, Glue, Athena, and Bedrock. Built a Text-to-SQL GenAI agent with Claude 3 Sonnet. Resolved small file issues with Snappy and Parquet compression. Optimized ETL processes for enterprise-scale data access.
