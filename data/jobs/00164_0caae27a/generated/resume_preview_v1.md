...
2001 – 2007
- Developed and supported high-availability C++/Pro*C/PL/SQL billing interfaces for telecom-scale transaction systems.
- Improved database performance by 10x through SQL, sequence, and process optimization while reducing memory usage by 75%.
- Built Unix/Linux automation using Korn shell, Perl, Awk, Syncsort, and SQL to support reporting, deployments, housekeeping, and operational data processing.
- Supported production issue triage, QA cycles, release support, documentation, and cross-team troubleshooting across billing and customer-management systems.
