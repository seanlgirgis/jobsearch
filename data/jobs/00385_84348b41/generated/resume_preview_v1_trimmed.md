...
**Sean Luka Girgis**  
Python Backend / Data Engineer | APIs, AI/ML Pipelines, AWS & Production Systems  
...
Python backend/data engineer with strong enterprise experience building and supporting Python, SQL, PySpark, AWS, API-style integrations, data pipelines, production reporting systems, and AI/ML-adjacent workflows. Experienced turning prototypes and data workflows into reliable production-ready systems with validation checks, operational support, documentation, and stakeholder collaboration. Best aligned to backend roles supporting AI/ML applications, APIs, microservices concepts, data-intensive systems, model-serving readiness, AWS cloud workflows, Docker, and production reliability; FastAPI/Django, Redis, Kubernetes, Azure, and formal MLOps are positioned carefully as adjacent or active-learning areas rather than overstated production ownership.
...
- Prepared forecasting-ready datasets for Prophet and scikit-learn workflows, supporting capacity planning, trend analysis, bottleneck prediction, and AI/ML-adjacent infrastructure planning.
...
Built Python/Pandas/PySpark workflows to process telemetry, validate outputs, prepare forecasting datasets, and support AI/ML-driven capacity planning and bottleneck prediction.
