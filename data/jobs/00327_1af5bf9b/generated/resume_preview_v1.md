...
**Sean Luka Girgis**  
AWS / PySpark Data Platform Lead | Data Quality, Governance & Enablement  
...
Senior Data Engineer and data platform lead with 20+ years of enterprise technology experience across AWS data platforms, Python, SQL, PySpark/Spark, AWS Glue, S3, Redshift, ETL/ELT pipelines, data quality, metadata documentation, governance-aware delivery, stakeholder enablement, and production troubleshooting. Strong background translating business and architecture needs into scalable data workflows, curated reporting layers, validation practices, and operational standards for enterprise teams. Best aligned to AWS/PySpark data platform and enablement roles requiring hands-on delivery, data quality frameworks, governance collaboration, stakeholder communication, and practical lakehouse modernization; Databricks, Delta Lake, Kinesis/Kafka, Lambda, and MLflow are positioned as adjacent or active-learning areas rather than overstated production ownership.
...
- Established repeatable data engineering practices around ingestion, transformation, validation, reconciliation, SQL optimization, reporting layers, and operational documentation.
...
- Developed schema-aware reporting layers, metric definitions, data dictionaries, and support documentation that improved data accessibility for technical and non-technical stakeholders.
...
- Partnered with infrastructure, architecture, analytics, application, and business stakeholders to translate requirements into production-ready data products and resolve delivery blockers.
- Supported AI/ML-oriented analytics by preparing curated, validated datasets for Prophet and scikit-learn forecasting workflows and executive capacity insights.
