...
**Sean Luka Girgis**  
Senior Data Engineer | AWS, SQL, Python, Parquet & Production Data Systems  
...
Senior Data Engineer with 20+ years of enterprise technology experience across AWS data platforms, SQL, Python, PySpark/Spark, ETL/ELT pipelines, Apache Parquet, production data systems, data quality, documentation, mentoring, and technical standards. Strong background building scalable data workflows, optimizing SQL and reporting layers, troubleshooting production systems, documenting operational procedures, and delivering reliable analytics datasets for business and technical stakeholders. Best aligned to senior data engineering roles requiring AWS, SQL/T-SQL/Postgres-adjacent database depth, Python, Parquet, scalable system design, production support, documentation, mentoring, and cross-functional technical leadership; OpenSearch/Elasticsearch and C# are positioned as adjacent or secondary areas rather than overstated production ownership.
...
- Developed scalable, maintainable data processing workflows using SQL, Python, PySpark, Parquet-oriented patterns, schema discipline, and partition-aware design.
...
- Created technical documentation, metric definitions, runbooks, transformation notes, and support procedures to improve knowledge sharing and operational consistency.
- Partnered with infrastructure, application, analytics, and business stakeholders to establish repeatable delivery practices, mentor teammates, and align technical solutions with business needs.
...
- Supported production system reliability by correlating application telemetry, transaction behavior, and infrastructure performance trends.
...
- Established reusable dashboard, alert, SLA threshold, and documentation standards adopted across client environments.
...
## Skills
**Languages:** Python, SQL, PySpark, PL/SQL, XML, JSON, Perl, Korn Shell, C++, Java, C# secondary/legacy exposure
