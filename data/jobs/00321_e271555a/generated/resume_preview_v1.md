...
**Sean Luka Girgis**  
Senior Data Engineer | Python, SQL, Spark, Cloud Pipelines & Data Quality  
...
Senior Data Engineer with 20+ years of enterprise technology experience across Python, SQL, Spark/PySpark, cloud data platforms, ETL/ELT pipelines, data quality validation, production support, observability, root cause analysis, and regulated enterprise data environments. Strong background building and operating production-grade pipelines, validation frameworks, monitoring workflows, curated reporting layers, and reliable data products for technical and business stakeholders. Best aligned to roles requiring batch/streaming-style data engineering, cloud-native pipeline delivery, data accuracy, completeness, freshness, reliability, and secure data handling; healthcare interoperability formats such as HL7, FHIR, CCDA, ADT, Epic, Cerner, HEDIS, and HCC are positioned as domain-adjacent learning areas rather than overstated production ownership.

## Professional Experience
### Senior Capacity & Data Engineer at CITI
2017-11 – 2025-12
- Built Python/Pandas/PySpark ETL pipelines ingesting telemetry from 6,000+ infrastructure endpoints and transforming raw operational data into curated datasets for reporting, analytics, forecasting, and stakeholder decision-making.
- Designed AWS-based data platform components using S3 landing zones, AWS Glue, Athena, Redshift, Oracle, SQL, and PySpark to support scalable transformation, querying, and production reporting workflows.
- Built data quality, reconciliation, and validation practices across BMC TrueSight, CA Wily, AppDynamics, Oracle, and AWS-backed reporting layers to improve accuracy, completeness, and trust in pipeline outputs.
- Instrumented production data workflows with monitoring, alerting concepts, troubleshooting checkpoints, operational runbooks, and review processes to improve reliability and issue detection.
- Performed root cause analysis for data and reporting issues, coordinating with infrastructure, application, monitoring, and analytics teams to restore trust in business-facing outputs.
...
- Developed schema-aware reporting layers, dashboards, and curated datasets that supported executive capacity insights, forecasting workflows, and operational analytics.
- Documented pipeline logic, metric definitions, validation assumptions, operational support steps, and data handling practices for regulated enterprise environments.
...
- Supported production troubleshooting, monitoring readiness, transaction visibility, and data/reporting needs during AWS cloud migration planning.
...
- Built automation scripts in Korn shell, Perl, Awk, Syncsort, and SQL to support data processing, reporting, deployments, and operational housekeeping.
