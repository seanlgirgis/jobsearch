...
**Sean Luka Girgis**  
AWS Data Engineer | Glue, Redshift, SQL, Dimensional Modeling & ETL  
...
Senior AWS Data Engineer with 20+ years of enterprise technology experience across AWS data platforms, Python, SQL, PySpark/Spark, AWS Glue, Redshift, ETL/ELT pipelines, data warehousing, dimensional modeling, SQL performance tuning, data quality, and production reporting systems. Strong background building scalable data workflows, curated reporting layers, validation checks, performance-oriented schemas, and stakeholder-facing analytics for regulated enterprise environments. Best aligned to AWS data engineering roles requiring Glue, Redshift, advanced SQL, data warehousing, dimensional modeling, ETL/ELT, data quality, governance, and reliable delivery; dbt, AWS CDK, Jinja, CodePipeline/CodeCommit, MWAA, Step Functions, Lambda, and CDC are positioned as adjacent or active-learning areas rather than overstated production ownership.

## Professional Experience
### Senior Capacity & Data Engineer at CITI
2017-11 – 2025-12
- Designed AWS-based data platform components using S3 landing zones, AWS Glue, Athena, Redshift, Oracle, SQL, and PySpark to support scalable transformation, querying, analytics, and forecasting workloads.
...
- Developed Redshift- and Oracle-backed reporting layers with optimized SQL queries, historical retention models, schema discipline, indexes, views, and partition-aware design patterns.
- Applied dimensional modeling concepts, metric definitions, curated reporting datasets, and stakeholder-ready data structures to make complex infrastructure telemetry easier to analyze and consume.
...
- Refactored manual and legacy reporting workflows into repeatable ETL processes with documented extraction logic, validation checkpoints, transformation rules, and operational support steps.
- Optimized SQL queries, Oracle schemas, Redshift-backed workloads, and reporting data models for performance, maintainability, and cost-aware access.
- Partnered with infrastructure, analytics, application, and business stakeholders to translate requirements into production-ready data products, dashboards, and support documentation.
