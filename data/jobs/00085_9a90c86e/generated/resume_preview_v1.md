...
### Data Engineer / Capacity Data Engineering - CITI at CITI
2017-11 – 2025-12
...
### CA APM Consultant at CA Technologies/ TIAA-CREF
2011 – 2016
...
## Skills
**Monitoring & APM:** Dynatrace (AppMon, Synthetics), BMC TrueSight/TSCO, CA APM/Introscope, AppDynamics
**Languages:** Python, SQL, Perl, Ksh, Java, C++
**Platforms:** Linux/Unix, AWS (S3, Glue, Athena, Redshift)
**Data & Automation:** Telemetry Pipelines, ETL, Data Warehousing, PySpark
**Tools:** Airflow, Docker, Git, Streamlit

## Flagship Projects
### FAST Project (Dynatrace)
Improved monitoring outcomes through real-user performance data analysis (Gomez), enabling targeted optimization actions and better visibility for engineering teams.
**Technologies:** Dynatrace AppMon, Dynatrace Synthetics, Gomez Synthetic Monitoring

### HorizonScale — Telemetry Analytics Platform
Developed Python/PySpark telemetry analytics pipelines and reporting dashboards, improving speed and consistency of capacity and performance reporting workflows.
