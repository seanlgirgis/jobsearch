...
**Sean Luka Girgis**  
APM / Observability Engineer | Dynatrace AppMon, CA APM, AppDynamics & Telemetry  
...
Senior APM, observability, performance, and capacity engineering professional with 20+ years of enterprise technology experience across Dynatrace AppMon, Gomez Synthetic Monitoring, CA APM/Introscope, AppDynamics, BMC TrueSight, Linux/Unix, infrastructure telemetry, dashboards, alerting, synthetic monitoring, performance analysis, documentation, and production troubleshooting. Strong background supporting enterprise monitoring platforms, onboarding telemetry, building operational dashboards and reports, defining thresholds, reducing troubleshooting friction, and translating performance signals into actionable operational insights. Best aligned to observability/APM roles requiring enterprise monitoring, application visibility, synthetic monitoring, dashboards, reporting, incident troubleshooting, Python/shell automation, documentation, and knowledge sharing; modern Dynatrace SaaS features, Grail, Davis AI, OTel, advanced RUM/mobile, ServiceNow/PagerDuty integrations, Terraform/CDK, and formal SRE SLIs/SLOs are positioned carefully as adjacent or learning areas rather than overstated production ownership.
...
- Troubleshot production monitoring and reporting issues by tracing source feeds, transformation logic, metric behavior, latency symptoms, failed outputs, and downstream reporting discrepancies.
