...
Senior Data Engineer with over 20 years of enterprise experience, specializing in designing scalable data pipelines and ETL/ELT workflows using Python and AWS cloud platforms. Proficient in SQL/NoSQL databases, cloud-native solutions, and orchestration tools like Apache Airflow, I excel in building automation tools and reusable frameworks for data engineering. My expertise includes CI/CD pipelines, Docker containerization, and microservices architecture, ensuring efficient and scalable solutions. I have a proven track record of driving architectural decisions and mentoring teams to deliver high-quality enterprise platforms. I am passionate about contributing to Toyota North America's mission of innovation through Toyota Financial Services by leveraging my skills in data validation and real-time streaming. I am eager to collaborate with cross-functional teams in Plano, TX, to enhance platform capabilities and deliver impactful results.
...
- Automated data workflows and reporting using Python scripts, improving delivery speed and quality.
...
- Mentored technical teams on APM implementation and optimization best practices.
- Documented implementations and supported clients with troubleshooting and training.

### Performance Test Engineer at AT&T
2010-08 – 2011-07
- Analyzed J2EE telecom applications for load and break points, documenting key metrics like JDBC, threads, and memory usage.
...
- Identified resource bottlenecks to optimize application performance.
...
- Achieved 75% memory reduction and 20% throughput gain in billing systems through performance tuning (C/C++/Pro*C/PL/SQL).
- Automated system administration for WebLogic/WebSphere environments using Korn Shell scripts.
- Designed and implemented interfaces with UML, Rational Rose, and design patterns.
...
## Skills
Python, SQL / Oracle, AWS, ETL Design & Optimization, Airflow, Docker, Git, Data Quality & Pipeline Validation, Pandas, PySpark, Apache Spark, C++, Perl, Ksh / Korn Shell Scripting, Java, PL/SQL, Prophet / Time-Series Forecasting, GenAI / LLM Agents, scikit-learn, Dynatrace (AppMon + Synthetics), CA APM / Introscope, BMC TrueSight / TSCO, Oracle RAC, Data Warehousing, Streamlit, Multiprocessing, Hive/Hadoop, Linux/Unix, OCCI / OCI, WebLogic / WebSphere, VB6 / VC++, Capacity Planning / Forecasting, Apache Parquet / Columnar Storage, Dimensional Modeling, Databricks, Delta Lake, Medallion Architecture, Unity Catalog, Delta Live Tables, Databricks Workflows, dbt, Data Governance, Snowflake, Data Vault

## Flagship Projects
### Serverless Lakehouse Platform (AWS)
Designed a full serverless data platform using S3, Glue, Athena, and Bedrock. Built a Text-to-SQL GenAI agent with Claude 3 Sonnet. Resolved small file issues using Snappy and Parquet compression. Optimized ETL processes and data access for enterprise-scale operations.
**Technologies:** AWS Glue, Athena, Bedrock (GenAI), S3, PySpark

### HorizonScale — AI Capacity Forecasting Engine
Replaced legacy manual processes with a parallel generator-based pipeline, reducing forecasting cycles by 90%. Developed an interactive Streamlit dashboard for real-time capacity insights and 'High Trust' utilization scores. Built a modern agentic pipeline for banking-scale telemetry. Featured advanced ML models and comprehensive documentation.
