...
Built a Python automation pipeline with semantic duplicate detection, LLM-based scoring, JSON artifact generation, quality gates, document rendering, and application tracking. Emphasized structured data processing, validation, API integration, and reliable workflow orchestration.
