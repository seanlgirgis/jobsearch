...
**Sean Luka Girgis**  
Lead Data Engineer | AWS, Spark, SQL, ETL Modernization & Data Quality  
...
Lead Data Engineer with 20+ years of enterprise technology experience across AWS data platforms, Spark/PySpark, SQL, ETL modernization, data modeling, data quality, telemetry pipelines, and production reporting systems. Strong background leading cross-functional technical work, translating business requirements into scalable data solutions, optimizing high-volume data workflows, and documenting reliable production processes. Best aligned to roles needing AWS, Spark/PySpark, SQL, ETL migration, data validation, stakeholder communication, and technical leadership; Databricks, Scala, Workday HCM, and Informatica are positioned as adjacent or learning areas rather than overstated production ownership.

## Professional Experience
### Senior Capacity & Data Engineer at CITI
2017-11 – 2025-12
- Led design and delivery of Python, Pandas, PySpark, SQL, and AWS-based data pipelines ingesting telemetry from 6,000+ infrastructure endpoints for enterprise analytics and forecasting.
- Designed AWS data platform components using S3 landing zones, AWS Glue, Athena, Redshift, Oracle, SQL, and PySpark to support scalable reporting, transformation, and model-ready datasets.
- Modernized manual and legacy reporting workflows into repeatable ETL pipelines, improving reliability, maintainability, and stakeholder access to curated data.
- Built data quality, reconciliation, and validation practices across BMC TrueSight, CA Wily, AppDynamics, Oracle, and AWS-backed reporting layers to improve trust in pipeline outputs.
- Optimized SQL queries, Oracle schemas, Redshift-backed workloads, historical retention models, and partitioning patterns for performance, scalability, and cost-aware access.
- Translated business and infrastructure requirements into technical designs, reporting structures, dashboards, and operational data products for technical and non-technical stakeholders.
- Mentored and coordinated across infrastructure, monitoring, application, and analytics teams to resolve production data issues and improve delivery outcomes.
- Documented pipeline logic, metric definitions, operational runbooks, support steps, and architecture decisions to improve governance, knowledge transfer, and production readiness.
