...
**Sean Luka Girgis**  
Data Engineer | AWS, Python, SQL, ETL/ELT & AI-Ready Data Platforms  
...
Senior Data Engineer with 20+ years of enterprise technology experience across AWS data platforms, Python, SQL, PySpark/Spark, ETL/ELT pipelines, data lakes, data warehouses, Redshift, Glue, Athena, S3, forecasting datasets, and AI-ready data workflows. Strong background building scalable pipelines, curated reporting layers, data quality checks, performance-tuned SQL, telemetry analytics, and stakeholder-facing data products in regulated enterprise environments. Best aligned to cloud data engineering roles requiring AWS, Python, SQL, ETL/ELT, orchestration, model-ready datasets, and AI/RAG-supporting data foundations; Terraform, dbt, Snowflake, Databricks, BigQuery, and broader multi-cloud are positioned carefully as adjacent or active-learning areas rather than overstated production ownership.
...
- Developed cloud-oriented ETL/ELT workflows for data ingestion, cleansing, enrichment, standardization, validation, and delivery to analytics and operational reporting consumers.
...
- Developed Streamlit, matplotlib, seaborn, and plotly dashboards that surfaced capacity, performance, and trend insights for senior stakeholders and technical teams.
