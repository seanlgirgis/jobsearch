...
Senior Data Engineer with over 20 years of enterprise experience, specializing in designing scalable data pipelines and automation solutions for high-performance platforms. Proficient in Python programming, SQL expertise, and big data technologies like Apache Spark and PySpark, with extensive experience in data warehousing, ETL processes, and cloud services such as AWS and Azure. Skilled in creating executive reporting tools and dashboards using modern BI tools, ensuring compliance and governance in data analytics environments. Adept at driving innovation through CI/CD pipelines and automation frameworks, with a focus on platform health monitoring. Passionate about mentoring teams and collaborating cross-functionally to deliver data-driven insights. Eager to contribute to Geico’s mission of building cutting-edge data analytics solutions within the Data Analytics and Vertical Engineering team.
...
- Automated workflows and reporting using Python scripts to improve operational efficiency.

### Performance Engineer at G6 Hospitality LLC
2017-03 – 2017-11
- Managed Dynatrace AppMon/Synthetics for critical systems and Brand.com, ensuring performance monitoring.
...
- Reverse-engineered and documented AMDOCS PRM and APIs for system improvements.
...
## Skills
Python, SQL / Oracle, AWS, PySpark, Data Warehousing, ETL Design & Optimization, Airflow, Docker, Git, Capacity Planning / Forecasting, Pandas, Prophet / Time-Series Forecasting, scikit-learn, Hive/Hadoop, GenAI / LLM Agents, Streamlit, Multiprocessing, Linux/Unix, BMC TrueSight / TSCO, C++, PL/SQL, Oracle RAC, OCCI / OCI, Java, Perl, Ksh / Korn Shell Scripting, Dynatrace (AppMon + Synthetics), CA APM / Introscope, WebLogic / WebSphere, VB6 / VC++
