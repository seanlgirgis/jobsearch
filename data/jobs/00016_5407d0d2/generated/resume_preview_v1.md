...
2007-10 – 2008-05
- Conducted UML design and module development for a CICS/MQSeries/XML/DB2 system for IRS modernization.
- Developed modules using VC++ and DB2, ensuring reliable data processing.
- Designed system architecture with a focus on performance and scalability.
...
- Improved database performance by 10x using sequences and optimized queries for scalability.
- Automated system administration for WebLogic/WebSphere with Korn Shell scripts, enhancing efficiency.
- Designed and implemented EDI interfaces and Flexible Bill Formatter for data processing.
- Troubleshot and supported Enabler/CSM/EMS modules, ensuring system reliability and performance.
...
- Performed various administrative tasks to ensure system reliability and user support.
