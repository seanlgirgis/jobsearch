...
Dallas, TX · 1 month ago · Over 100 applicants
...
Katelyn Young 
• 2nd
Recruiter at Peyton Resource Group
Job poster

About the job
HYBRID role in Dallas, Texas (LOCAL CANDIDATES ONLY)
...
•	Propose, pilot and implement new tools and frameworks to enhance scalability testing requirements and performance visibility
...
•	Constantly review and monitor the performance test suite to identify new opportunities to improve system reliability and scalability.
•	Define and manage the performance engineering strategy and roadmap for the Testing team with constant improvements and modifications based on new technologies and new ways of working. Must work closely with the Testing Enablement Function Lead to identify and foster creation and usage of performance services for various phases of testing and have them ready prior to testing cycles. Early identification of various opportunities is key. 
...
•	Must be able to show a tangible result with improved performance test metrics
Required Skills & Experience: 
•	10 + years of experience and strong knowledge of performance engineering and scalability principles. 
•	Proven expertise assessing existing tools ecosystems and recommending improvements. 
•	Hands on experience with performance testing tools like Neoload and JMeter is a must. 
•	Solid understanding of performance concepts and suggesting improvements to the development team is a must. 
•	Experience with cloud native scalability testing is required. 
•	Exposure to APM (monitoring) tools like Grafana and Dynatrace is required 
