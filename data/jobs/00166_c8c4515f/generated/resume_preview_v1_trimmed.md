...
**Sean Luka Girgis**  
Senior AWS Data Engineer | Data Architecture, SQL Reporting & Cloud Migration  
...
Senior AWS Data Engineer and data architecture specialist with 20+ years of enterprise technology experience across cloud data platforms, SQL reporting layers, semi-structured data processing, schema design, ETL/ELT pipelines, metadata-driven reporting, and stakeholder-facing analytics. Strong background using Python, SQL, AWS S3, Glue, Athena, Redshift, Oracle, PySpark, XML, JSON, performance tuning, documentation, and production monitoring to modernize data workflows and make complex data queryable for business users. Experienced translating ambiguous reporting needs into durable data models, migration plans, architecture decisions, and operational runbooks.

## Professional Experience
### Senior Capacity & Data Engineer at CITI
2017-11 – 2025-12
- Designed AWS-based data platform components using S3 landing zones, AWS Glue, Athena, Redshift, Oracle, SQL, and PySpark to support scalable reporting, analytics, and forecasting workloads.
- Built Python/Pandas/PySpark ETL pipelines ingesting telemetry from 6,000+ infrastructure endpoints and transforming raw operational data into curated datasets for business and technical stakeholders.
...
- Designed SQL reporting structures, historical retention schemas, and queryable data layers that made complex infrastructure telemetry easier to analyze and consume.
- Optimized SQL queries, Oracle schemas, Redshift-backed workloads, partitioning patterns, retention strategy, and reporting data models for performance, maintainability, and cost-aware access.
- Built metadata-aware reporting and documentation practices, including metric definitions, pipeline logic, operational support steps, and data interpretation notes for technical and non-technical audiences.
- Validated and reconciled data across BMC TrueSight, CA Wily, AppDynamics, Oracle, and AWS-backed reporting layers to improve trust, completeness, and data quality.
- Monitored production data workflows, investigated failures, improved operational runbooks, and supported issue resolution across high-volume enterprise data pipelines.

### Performance Engineer at G6 Hospitality LLC
2017-03 – 2017-11
- Developed analytics and reporting outputs from Dynatrace AppMon and Gomez Synthetic Monitoring data for Brand.com and hospitality systems.
- Led the FAST project, mining real-user and synthetic performance data to identify optimization opportunities and communicate findings to engineering teams.
...
## Skills
**Languages:** Python, SQL, PySpark, PL/SQL, XML, JSON, Perl, Korn Shell, C++
