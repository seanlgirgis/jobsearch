...
**Sean Luka Girgis**  
Senior AWS / PySpark Data Engineer | Glue, Python, SQL & ETL Pipelines  
...
Senior AWS Data Engineer with 20+ years of enterprise technology experience and strong hands-on background in AWS data platforms, Python, SQL, PySpark/Spark, AWS Glue, S3, Athena, Redshift, ETL/ELT pipelines, structured and semi-structured data, data quality, pipeline reliability, performance tuning, and production troubleshooting. Experienced building scalable cloud-oriented data workflows, optimizing SQL and PySpark processing, validating pipeline outputs, and delivering stakeholder-ready analytics in regulated enterprise environments. Best aligned to AWS/PySpark/Glue roles requiring Python, SQL, reusable ETL code, JSON/Parquet data handling, production monitoring, cost-aware design, and reliable pipeline delivery; Terraform is positioned as active learning/working knowledge rather than overstated production ownership.
...
- Developed clean, reusable Python, SQL, and PySpark transformation logic for data cleansing, enrichment, aggregation, validation, reporting, and stakeholder-facing analytics.
- Worked with structured and semi-structured operational data using SQL, XML, JSON, Parquet-oriented patterns, schema discipline, partition-aware design, and historical retention models.
...
- Collaborated with infrastructure, analytics, application, and business stakeholders to translate requirements into reliable data products, dashboards, runbooks, and support documentation.
