...
**Sean Luka Girgis**  
Senior Data Engineer | AWS, Python, SQL, Data Migration & Data Quality  
...
Senior Data Engineer with 20+ years of enterprise technology experience across AWS data platforms, Python, SQL, PySpark/Spark, ETL/ELT pipelines, data migration, data warehousing, data quality, validation testing, CI/CD concepts, Agile delivery, and financial services technology. Strong background building and validating scalable data pipelines, optimizing SQL, documenting transformation logic, troubleshooting production data issues, and delivering stakeholder-ready analytics in regulated enterprise environments. Best aligned to AWS/Python/SQL data engineering roles requiring S3, Glue, Lambda concepts, data migration, data quality, validation, and financial services delivery; Snowflake is positioned as self-study/transferable warehouse experience rather than overstated production ownership.
...
- Developed cloud-oriented data pipelines for ingestion, cleansing, enrichment, standardization, validation, and delivery to analytics and operational reporting consumers.
...
- Documented transformation rules, metric definitions, validation checkpoints, operational runbooks, and support steps to improve repeatability and auditability.
- Collaborated with infrastructure, analytics, application, and business stakeholders in a regulated financial services environment to deliver reliable data products aligned with business needs.
