...
**Sean Luka Girgis**  
Enterprise SRE / Observability Engineer | BMC TrueSight, Dynatrace, Python & Linux  
...
Senior enterprise SRE, observability, performance, and platform support professional with 20+ years of experience across BMC TrueSight/TSCO, Dynatrace AppMon, CA APM/Introscope, AppDynamics, Python, Linux/Unix, monitoring, production troubleshooting, workflow automation concepts, CI/CD concepts, cloud platform support, and operational reporting. Strong background supporting large enterprise environments, building telemetry pipelines and dashboards, reducing troubleshooting friction, documenting runbooks, and partnering across infrastructure, application, product, and engineering teams. Best aligned to SRE/observability/platform-support roles requiring enterprise monitoring, production support, Python/shell automation, Linux, cloud concepts, CI/CD awareness, workflow automation, and ServiceNow/BMC Remedy-style ITSM exposure; Ansible Tower, Terraform, Windows administration, .NET, and Tableau are positioned carefully as adjacent or transferable areas rather than overstated production ownership.

## Professional Experience
### Senior Capacity & Data Engineer at CITI
2017-11 – 2025-12
- Supported enterprise monitoring and capacity workflows across BMC TrueSight/TSCO, CA Wily/APM, AppDynamics, Oracle, AWS-backed reporting layers, and large-scale infrastructure telemetry sources.
...
- Partnered with infrastructure, application, analytics, product, and engineering stakeholders to translate platform signals into practical recommendations for operational stability and service delivery.
- Supported production issue analysis by investigating telemetry feeds, metric behavior, source data quality, failed outputs, latency symptoms, and downstream reporting discrepancies.
- Created KPI-based dashboards and reporting models that converted utilization, performance, and capacity telemetry into actionable views for technical teams and senior stakeholders.
- Developed runbooks, metric definitions, validation checkpoints, reporting logic, support procedures, and documentation to improve repeatability, knowledge sharing, and team onboarding.
- Used Python, SQL, Linux/Unix-style automation patterns, and Git-based workflow discipline to support repeatable operational reporting, data validation, and troubleshooting workflows.
