...
I am interested in the Senior Data Engineer – Data Analytics and AI Focused role with Accylerate. The position aligns strongly with my background in AWS Redshift, Glue, S3, Python, PySpark, ETL/ELT validation, data quality, reconciliation, production troubleshooting, and pipeline reliability.
...
I want to be direct about fit: my strongest production background is AWS Glue/S3/Athena/Redshift with Python, SQL, PySpark, and data validation. dbt, CDK, DMS, PySpark Deequ, EventBridge, and QuickSight/Quicksuite are adjacent or active-learning areas for me rather than deep production ownership. Where I would bring immediate value is practical data QA, ETL validation, automated checks, pipeline reliability, SQL troubleshooting, and high-quality data deliverables.

I would welcome the opportunity to discuss how my AWS, Python, PySpark, SQL, ETL validation, data quality, and production support background can support Accylerate's EdTech data analytics and AI-focused work.
