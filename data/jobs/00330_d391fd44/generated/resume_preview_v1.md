...
**Sean Luka Girgis**  
Senior Data Engineer | Python, PySpark, Spark SQL, AWS & Data Governance  
...
Former Citi Senior Data Engineer with 20+ years of enterprise technology experience and strong hands-on background in Python, SQL, PySpark/Spark, ETL/ELT pipelines, AWS data platforms, Redshift, Oracle, data quality, governance-aware delivery, reporting, performance tuning, and production troubleshooting. Experienced building scalable telemetry and analytics pipelines, optimizing SQL and pipeline performance, documenting metadata and metric definitions, and supporting regulated enterprise reporting systems. Best aligned to Citi data engineering roles requiring Python, PySpark, Spark SQL, ETL/ELT, AWS/Redshift, data quality, governance, analytics pipelines, and stakeholder collaboration; Databricks, Delta Lake, Snowflake, Starburst/Trino, Apache Iceberg, and Ab Initio are positioned as adjacent or active-learning areas rather than overstated production ownership.
...
- Developed Spark/PySpark and SQL-based transformation logic for large-scale telemetry processing, historical retention, schema-aware reporting, and performance-oriented analytics datasets.
...
- Built data quality, reconciliation, and validation practices across BMC TrueSight, CA Wily, AppDynamics, Oracle, and AWS-backed reporting layers to improve consistency, completeness, and trust in pipeline outputs.
- Supported governance-aware delivery by documenting metric definitions, data assumptions, lineage-style notes, operational runbooks, access considerations, and stakeholder-facing reporting logic.
- Partnered with infrastructure, application, analytics, architecture, and business stakeholders to gather requirements, troubleshoot data issues, and deliver production-ready data products aligned to Citi standards.
- Prepared model-ready and analytics-ready datasets supporting Prophet/scikit-learn forecasting workflows, capacity insights, and AI/ML-adjacent experimentation in a regulated banking environment.
