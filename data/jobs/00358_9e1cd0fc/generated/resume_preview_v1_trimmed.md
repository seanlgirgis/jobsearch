...
**Sean Luka Girgis**  
Data Engineer | SQL, Python, ELT, Data Quality & Warehouse Reporting  
...
Senior Data Engineer with 20+ years of enterprise technology experience across SQL, Python, ELT/ETL pipelines, data warehousing, data modeling, data quality, validation, documentation, reporting/dashboard support, Git concepts, and cloud data platforms. Strong production background with Oracle, Amazon Redshift, AWS S3/Glue/Athena, PySpark, and Python-driven automation, plus experience building trusted analytics datasets and validating reporting outputs in regulated enterprise environments. Best aligned to SQL/Python data engineering roles requiring warehouse transformations, quality checks, documentation, Git-based modular development, reporting support, and stakeholder communication; Snowflake, dbt, OpenFlow, healthcare/EMR systems, HIPAA-specific workflows, Cognos/SAS/SPSS/Crystal Reports, and Microsoft SQL Server are positioned carefully as adjacent or learning areas rather than overstated production ownership.

## Professional Experience
### Senior Capacity & Data Engineer at CITI
2017-11 – 2025-12
- Built SQL, Python/Pandas, and PySpark ETL/ELT pipelines ingesting telemetry from 6,000+ infrastructure endpoints and transforming raw operational data into curated datasets for reporting, analytics, forecasting, validation, and decision support.
...
- Developed SQL-heavy transformation workflows, reporting tables, data marts, validation queries, and reusable datasets for technical and business stakeholders in a regulated financial-services environment.
- Implemented data quality and reconciliation practices across BMC TrueSight/TSCO, CA Wily/APM, AppDynamics, Oracle, and AWS-backed reporting layers to improve accuracy, completeness, consistency, and trust in reporting outputs.
...
- Documented data flows, source mappings, metric definitions, transformation rules, dependencies, validation checkpoints, and support procedures to improve visibility and reuse across reporting workflows.
- Used Python scripting and SQL to automate data manipulation, validation, reconciliation, reporting preparation, and production troubleshooting.
- Partnered with infrastructure, analytics, application, engineering, and business teams to translate requirements into reliable datasets, dashboards, documentation, and operational recommendations.
