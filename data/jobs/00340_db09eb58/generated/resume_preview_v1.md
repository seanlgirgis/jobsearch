...
**Sean Luka Girgis**  
Lead SQL / Data Integration Engineer | ETL, Data Quality & Financial Services  
...
Senior Data Engineer and technical delivery lead with 20+ years of enterprise technology experience across SQL, Oracle, PL/SQL, Python, ETL/ELT pipelines, data integrations, data modeling, performance tuning, reconciliation, production support, runbooks, and financial services technology. Strong background building and operating mission-critical data workflows, validating data quality, optimizing database access patterns, documenting operational procedures, and partnering with technical and business stakeholders. Best aligned to lead SQL/data integration roles requiring ETL delivery, data quality controls, auditability, reconciliation, performance tuning, operational maturity, financial-services context, and AI-assisted engineering; SQL Server/T-SQL, Databricks, Snowflake, CDC, and streaming are positioned carefully as adjacent or transferable areas rather than overstated production ownership.
...
- Designed Oracle, SQL, AWS Glue, Athena, Redshift, S3, and PySpark-based data platform components supporting scalable transformation, querying, reporting, and downstream analytics in a regulated financial-services environment.
- Developed SQL-heavy reporting and integration workflows for loading, normalizing, validating, and versioning operational telemetry across monitoring, infrastructure, and analytics data sources.
...
- Optimized SQL queries, Oracle schemas, Redshift-backed workloads, indexes, views, partitioning patterns, historical retention models, and reporting data models for performance and maintainability.
...
- Documented transformation rules, metric definitions, data flow notes, runbooks, operational procedures, exception handling patterns, and support steps to improve delivery consistency and knowledge transfer.
- Used AI-assisted development workflows to accelerate Python/SQL work, documentation, quality review, JSON artifact generation, and repeatable delivery practices while preserving engineering review discipline.
...
- Supported production reliability by correlating application telemetry, transaction behavior, and infrastructure performance trends.
...
- Established reusable dashboard, alert, SLA threshold, reporting, and technical documentation standards adopted across client environments.
- Mentored technical teams and partnered with J2EE, WebLogic, infrastructure, database, and operations groups to analyze data, troubleshoot bottlenecks, and resolve production issues.
