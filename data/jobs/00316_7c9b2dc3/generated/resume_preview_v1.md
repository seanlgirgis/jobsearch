...
**Sean Luka Girgis**  
AWS / PySpark Data Engineer | Lakehouse Migration, SQL Optimization & Data Quality  
...
Senior Data Engineer with 20+ years of enterprise technology experience across AWS data platforms, Python, SQL, PySpark/Spark, ETL/ELT, data migration, reconciliation, data quality validation, Hadoop/Hive concepts, Parquet-based lakehouse patterns, and production reporting systems. Strong background transforming legacy/on-prem data workflows into scalable cloud analytics platforms using S3, Glue, Athena, Redshift, Oracle, Spark/PySpark, partitioning, schema design, and SQL optimization. Best aligned to AWS lakehouse migration roles requiring practical data engineering, large-scale processing, data quality, and stakeholder-ready reporting; Snowflake, Apache Iceberg, Kafka, and Kubernetes are positioned as adjacent or active learning areas rather than overstated production ownership.
...
- Applied Parquet, partitioning concepts, schema design, and SQL optimization patterns to improve large-scale data processing and reporting access.
...
- Documented pipeline logic, metric definitions, operational runbooks, data interpretation notes, and support steps to improve governance and production readiness.
