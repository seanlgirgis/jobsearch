<#
.SYNOPSIS
Create intake\intake.md from highlighted clipboard text for Wellfound jobs.

.DESCRIPTION
Reads clipboard text and rewrites intake\intake.md with this layout:
line 1: Wellfound.com
line 2-4: blank
line 5+: clipboard content

.EXAMPLE
.\06w.intake-from-clipboard-wellfound.ps1
#>
...
Write-Host "Source header set to: Wellfound.com" -ForegroundColor Green
