<#
.SYNOPSIS
Create intake\intake.md from highlighted clipboard text for LinkedIn jobs.
...
.EXAMPLE
.\06L.intake-from-clipboard-linkedin.ps1
#>
...
Write-Host "Source header set to: LinkedIn.com" -ForegroundColor Green
