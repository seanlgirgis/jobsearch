<#
.SYNOPSIS
Create intake\intake.md from highlighted clipboard text for Indeed jobs.
...
.EXAMPLE
.\06I.intake-from-clipboard-indeed.ps1
#>
...
Write-Host "Source header set to: Indeed.com" -ForegroundColor Green
